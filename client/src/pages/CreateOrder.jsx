...
const CreateOrder = () => {
  ...
  const [items, setItems] = useState([
    {
      ...
      type: 'product', // 'product' or 'custom'
      product: '', // Product ID
      customName: '',
      quantity: 1,
      unitPrice: 0,
        ...
        if (item.id === id) {
          ...
          if (field === 'product' && value !== '') {
            ...
            if (selectedProduct) {
              ...
              // Clear customName just to be clean
  ...
  // ─── Calculations ────────────────────────────────────────────
  // Instant dynamic calculations using useMemo
  ...
  const handleSave = async () => {
    ...
    // Validation: Check stock levels for inventory products
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Draft a new customer order</p>
          </div>
        </div>
              ...
              <div>
                ...
                {status !== 'draft' && (
                  <p className="text-xs text-amber-600 mt-1">
                    Warning: Saving in this status will deduct inventory.
                  </p>
                )}
              </div>
